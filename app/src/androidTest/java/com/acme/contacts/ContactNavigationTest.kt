...
import com.acme.contacts.list.ContactsListFragmentDirections
...
class ContactNavigationTest {
    ...
    fun testNavigateToContactDetails() {
        ...
        // 2. Create FragmentScenario instance, parameterized as a
    ...
    fun testNavigateBackOnSave() {
        ...
        // In this case you pass R.style.AppTheme which is defined in your styles.xml resource
        // folder and is a descendant of the AppCompat theme.
        val fragmentScenario =
            launchFragmentInContainer<ContactDetailFragment>(arguments, R.style.AppTheme)
        ...
        onView(withId(R.id.contact_name_tv)).check(matches(withText(expectedContact.name)));
        onView(withId(R.id.contact_number_tv)).check(matches(withText(expectedContact.phone)));
